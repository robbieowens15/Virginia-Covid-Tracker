...
def daily_increases_as_list(raw_data):
    ...
    for i in range(len(raw_data)-1):
        ...
        daily_increase = int(raw_data[i]) - int(raw_data[i+1])
...
example_localities = ["Hampton","Virginia Beach","Newport News","Fairfax", "Loudoun", "Albemarle"] #todo Temporary, list will be generated by email list
